    ...
    <aside class="sidebar d-none d-md-block">
      <div class="sidebar-box">
        ...
        <div class="d-grid gap-3">
          ...
          <a href="?c=Usuarios" class="btn btn-glow fs-5 text-decoration-none active"><i class="bi bi-people-fill me-2"></i>Usuarios</a>
    ...
    <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasSidebar">
      ...
      <div class="offcanvas-body">
        <div class="d-grid gap-3">
          ...
          <a href="#" class="btn btn-glow fs-5 text-decoration-none" data-bs-dismiss="offcanvas"><i class="bi bi-bar-chart-fill me-2"></i>Material</a>
        </div>
      </div>
    </div>
