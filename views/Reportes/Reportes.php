...
<head>
  ...
  <title>Sistema Educativo — Reportes (Dashboard)</title>
    ...
    <aside class="sidebar d-none d-md-block">
      <div class="sidebar-box">
        ...
        <div class="d-grid gap-3">
          ...
          <a class="link-glow fs-5" href="?c=Alumnos"><i class="bi bi-people-fill me-2"></i>Alumnos</a>
          <a class="link-glow fs-5" href="?c=Directores"><i class="bi bi-person-gear me-2"></i>Directores</a>
          <a class="link-glow fs-5" href="?c=Evaluacion"><i class="bi bi-clipboard-check-fill me-2"></i>Evaluación</a>
          <a class="link-glow fs-5 active" href="?c=Reportes"><i class="bi bi-bar-chart-fill me-2"></i>Reportes</a>
          <a href="?c=Material" class="btn btn-glow fs-5 text-decoration-none"><i class="bi bi-bar-chart-fill me-2"></i>Material</a>
        </div>
      </div>
    </aside>
    ...
    <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasSidebar">
      ...
      <div class="offcanvas-body">
        <div class="d-grid gap-3">
          ...
          <a class="link-glow fs-5" data-bs-dismiss="offcanvas" href="#">Alumnos</a>
          <a class="link-glow fs-5" data-bs-dismiss="offcanvas" href="#">Directores</a>
