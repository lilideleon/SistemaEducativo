      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item">
              <a href="?c=Menu" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Usuario</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="?c=Usuarios" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="?c=Productos" class="menu-link">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="?c=Categorias" class="menu-link">
                    <div data-i18n="Without menu">Categorias</div>
                  </a>
                </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="?c=Despieces" class="menu-link">
                    <div data-i18n="Without menu">Despieses Producto</div>
                  </a>
                </li>
