<?php
    ...
    $pdf->MultiCell(0,5,utf8_decode(strtoupper("ZAPATERIA CIFUENTES")),0,'C',false);
    $pdf->SetFont('Arial','',9);
   ...
   /* $pdf->MultiCell(0,4,utf8_decode("Nombre de producto a vender"),0,'C',false);
    ...
    # Codigo de barras #
    $pdf->Code128(5,$pdf->GetY(),"1/Eve01-35",70,20);
    $pdf->SetXY(0,$pdf->GetY()+21);
    $pdf->SetFont('Arial','',14);
    $pdf->MultiCell(0,5,utf8_decode("1/Eve01-35"),0,'C',false);
